...
XLFileName = "./Input_Files/Test.xls";
XLSheetName = "Sheet1";
...
ExcellObject.writeColumn(XLSheetName,2,"A",x,["Sumeet"])
...
# ylabel = "y";
# position = "A2"
# XData    = "Sheet1!$B$3:$B$6";
# YData    = "Sheet1!$B$3:$B$6"


# ExcellObject.ScatterChart(XLSheetName,title,xlabel,ylabel,position,XData,YData,YData)
